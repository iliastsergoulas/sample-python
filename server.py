...
class MyRequestHandler(BaseHTTPRequestHandler):
    ...
    def handle_get_user_info(self, query_params):
        try:
            ...
            get_user_query = "SELECT * FROM public.users WHERE username=:username AND userid=:userid"
            user_info = pd.read_sql_query(get_user_query, con=engine, params={"username": username, "userid": userid})
